        ...
        <>
            ...
            <div className={`w-full min-h-screen flex flex-col min-w-[350px] ${inter.className}`}>
                ...
                <footer className="w-full flex justify-center items-center bg-[#3a3a3a] text-white px-2 py-3">
                    <div className="w-full md:px-0 md:max-w-3xl lg:max-w-4xl xl:max-w-5xl flex gap-4 md:gap-12 flex-row justify-start items-center">
                        <img className="w-32 h-32 border-2 border-gray-200 object-cover object-center rounded-full shadow-lg antialiased" src="/images/author.jpg" />
