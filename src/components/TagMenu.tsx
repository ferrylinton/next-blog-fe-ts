    ...
    return (
        <>
            <div className='relative'>
                <button className={`h-[36px] px-2 sm:px-3 relative flex gap-1 sm:gap-2 items-center justify-center text-sm border text-stone-500 border-stone-300 ${open ? 'ring-2 ring-lime-200' : ''}`} onClick={() => setOpen(!open)}>
